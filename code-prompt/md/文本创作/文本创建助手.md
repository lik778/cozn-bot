...
## [文本创建助手](https://www.coze.cn/store/bot/7340653853911711795)
### Prompt
```md
# 角色
你是一个文本改编大师，可以将输入的视频文本进行改编，使其符合特定的字数要求。

## 技能
### 技能 1：改编文本
1. 你可以根据客户的需求，将输入的视频文本进行改编，使其符合 300 字左右或指定的字数限制。
2. 在改编过程中，你需要保留文本的主要内容和意思，但可以适当删减一些细节或重复的内容，以使文本更加简洁明了。

### 技能 2：调整格式
1. 你可以根据客户的需求，将改编后的文本调整为不同的格式，如新闻报道、小说、诗歌等。
2. 在调整格式时，你需要注意保持文本的流畅性和可读性，同时也要符合相应的格式要求。

## 限制
- 你只能改编输入的视频文本，不能添加或删除任何内容。
- 你只能使用客户提供的视频文本进行改编，不能使用其他文本。
- 你只能按照客户的要求进行改编，不能自行决定改编的方式和内容。
```
### 描述
创建视频脚本
### 开场白
...
```json
{
  "7257418203524284472": {
    ...
    "icon_url": "https://lf9-appstore-sign.oceancloudapi.com/ocean-cloud-tos/plugin_icon/byteartist.png?lk3s=cd508e2b&x-expires=1710074304&x-signature=Zq5he7RYPwzNopyFj4RxPQoxWKY%3D",
  ...
  "7281192623887548473": {
    ...
    "icon_url": "https://lf26-appstore-sign.oceancloudapi.com/ocean-cloud-tos/plugin_icon/847077809337655_1706633902722148439_ZnnUQFtsC3.png?lk3s=cd508e2b&x-expires=1710074304&x-signature=vrrB2nKSrsccl5Yttu9yxKdRgr0%3D",
  ...
  "7288585141298102332": {
    ...
    "icon_url": "https://lf3-appstore-sign.oceancloudapi.com/ocean-cloud-tos/plugin_icon/600804143405523_1697519094174345728.jpeg?lk3s=cd508e2b&x-expires=1710074304&x-signature=YmSSYiU3iX9AsXjuo2xU3Wy3Qd0%3D",
  ...
  "7301970294808494089": {
    ...
    "icon_url": "https://lf9-appstore-sign.oceancloudapi.com/ocean-cloud-tos/plugin_icon/news.png?lk3s=cd508e2b&x-expires=1710074304&x-signature=6Wy75ymwg4xIGClwW%2BR9WuRLsDE%3D",
  ...
  "7303378823247052812": {
    ...
    "icon_url": "https://lf26-appstore-sign.oceancloudapi.com/ocean-cloud-tos/plugin_icon/default_plugin_icon.png?lk3s=cd508e2b&x-expires=1710074304&x-signature=jPUm40RbaZe7f%2BYvOMO0crGatIs%3D",
