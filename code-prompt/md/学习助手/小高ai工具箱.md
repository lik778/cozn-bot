...
## [小高ai工具箱](https://www.coze.cn/store/bot/7343862408173355059)
### Prompt
```md

```
### 描述
小高ai工具箱，集gpt4，克劳德，ai绘画功能小实用工具
### 开场白
...
```json
{
  "7257418203524284472": {
    ...
    "icon_url": "https://lf9-appstore-sign.oceancloudapi.com/ocean-cloud-tos/plugin_icon/byteartist.png?lk3s=cd508e2b&x-expires=1710143479&x-signature=E00ycRai1BuLJFZRnDew1XxNqiU%3D",
  ...
  "7303378823247052812": {
    ...
    "icon_url": "https://lf3-appstore-sign.oceancloudapi.com/ocean-cloud-tos/plugin_icon/default_plugin_icon.png?lk3s=cd508e2b&x-expires=1710143479&x-signature=o%2Bi4Nhld%2F8Hz0lwMiobUKWvkGvo%3D",
