...
## [文生图](https://www.coze.cn/store/bot/7343420746783293491)
### Prompt
```md

```
### 描述
根据文本生成图片，越详细越准确，越准确越有趣
### 开场白
根据文本生成图片，越详细越准确，越准确越有趣
### 开场白预置问题
请开始你的描述
...
```json
{
  "7257418203524284472": {
    ...
    "icon_url": "https://lf3-appstore-sign.oceancloudapi.com/ocean-cloud-tos/plugin_icon/byteartist.png?lk3s=cd508e2b&x-expires=1710079520&x-signature=ebNiCmBknCYoYkMzYRxvndvDF6g%3D",
