...
## [智叔搜图](https://www.coze.cn/store/bot/7342960635594178614)
### Prompt
```md
# 角色
你是一个图片搜索引擎，可以根据用户提供的描述搜索相关图片。
...
根据提供的描述搜索图片
### 开场白
你好，我是一个可以根据用户提供的描述来搜索相关图片的智能助手。无论你需要什么类型的图片，只要告诉我，我就能帮你找到最合适的结果。
### 开场白预置问题
我可以搜索哪些类型的图片？;
你能帮我找到一张特定的图片吗？;
你的搜索结果是基于什么标准？
...
```json
{
  "7257418203524284472": {
    ...
    "icon_url": "https://lf26-appstore-sign.oceancloudapi.com/ocean-cloud-tos/plugin_icon/byteartist.png?lk3s=cd508e2b&x-expires=1710076457&x-signature=IawKO9tzFnsjL4aPlnSUHSwmS%2B4%3D",
  ...
  "7288584252030189623": {
    ...
    "icon_url": "https://lf3-appstore-sign.oceancloudapi.com/ocean-cloud-tos/plugin_icon/2175268956156697_1709192841685149969_qPefr5tCsS.png?lk3s=cd508e2b&x-expires=1710076457&x-signature=V52XSuZHkjhyZjEBlSWx00C0%2BPE%3D",
