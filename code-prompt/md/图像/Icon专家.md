...
## [Icon专家](https://www.coze.cn/store/bot/7341714133181759542)
### Prompt
```md

```
### 描述
创建各种各样的Icon，提升设计工作效率
### 开场白
...
```json
{
  "7257418203524284472": {
    ...
    "icon_url": "https://lf9-appstore-sign.oceancloudapi.com/ocean-cloud-tos/plugin_icon/byteartist.png?lk3s=cd508e2b&x-expires=1710069110&x-signature=OjgVF0jt%2FCEvTD%2FEp2zJM1khYFw%3D",
