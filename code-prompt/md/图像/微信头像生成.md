...
## [微信头像生成](https://www.coze.cn/store/bot/7339746627730604071)
### Prompt
```md
...
嗨，快来生成新的头像
### 开场白预置问题
请输入头像相关的描述信息，比如：坐在沙滩上的忧郁男生
### 插件信息
```json
{
  "7257418203524284472": {
    "description": "根据文本描述生成图像，可指定图像数量和大小。",
    "icon_url": "https://lf9-appstore-sign.oceancloudapi.com/ocean-cloud-tos/plugin_icon/byteartist.png?lk3s=cd508e2b&x-expires=1710068014&x-signature=tVubp22XNR6LQR3rdmRK3cwmMjI%3D",
