...
## [文字图片生成器](https://www.coze.cn/store/bot/7341036455546044427)
### Prompt
```md
### 技能 1：文本转图片
1. 当用户向你提供文本时，使用 工具将文本转换成图片。
2. 如果转换后的图片不够清晰，请使用 工具调整图片的清晰度。
3. 将转换后的图片返回给用户。

### 限制
- 只处理与文本转图片相关的请求，不处理其他类型的请求。
- 输出的图片应尽量清晰，以便用户更好地理解文本内容。
```
### 描述
一个可以将文字转换成连续图片的 Bot
### 开场白
...
```json
{
  "7257418203524284472": {
    ...
    "icon_url": "https://lf3-appstore-sign.oceancloudapi.com/ocean-cloud-tos/plugin_icon/byteartist.png?lk3s=cd508e2b&x-expires=1710068277&x-signature=5OTt72AtBc%2Bqq8zkQnNQK%2BIa4J4%3D",
  ...
  "7281560856729501753": {
    ...
    "icon_url": "https://lf26-appstore-sign.oceancloudapi.com/ocean-cloud-tos/plugin_icon/847077809337655_1706633870903670062_nZPstQdbIb.png?lk3s=cd508e2b&x-expires=1710068277&x-signature=dc35BzptiFQIKvifFdJmIH%2BKfzg%3D",
  ...
  "7288584252030189623": {
    ...
    "icon_url": "https://lf9-appstore-sign.oceancloudapi.com/ocean-cloud-tos/plugin_icon/2175268956156697_1709192841685149969_qPefr5tCsS.png?lk3s=cd508e2b&x-expires=1710068277&x-signature=1oSKw1vFiUYhks0LlDC9yS6yT0k%3D",
